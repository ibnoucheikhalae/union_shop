...
import 'package:union_shop/pages/login_page.dart';   // NEW
import 'package:union_shop/pages/signup_page.dart';  // NEW
...
class UnionShopApp extends StatelessWidget {
  ...
  '/login': (context) => const LoginPage(),      // NEW
  '/signup': (context) => const SignupPage(),    // NEW
},
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            // Hero Section (no NetworkImage to keep tests happy)
            SizedBox(
              height: 400,
              width: double.infinity,
              child: Stack(
